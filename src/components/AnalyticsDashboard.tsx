...
function AnalyticsDashboard({ avgVisitorsPerDay, amtVisitorsToday, timeseriesPageviews, topCountries }: AnalyticsDashboardProps) {
  return (
    <div className='flex flex-col gap-6'>
        <div className='grid w-full mx-auto grid-cols-1 sm:grid-cols-2 gap-6'>
            <Card className="w-full mx-auto max-w-xs rounded-2xl border-b-4 hover:border-[#ffffff] backdrop-blur-[1px]">
                <p className='text-tremor-default text-dark-tremor-content-strong'>
                    Avg. Visitors/day 
                </p>
            ...
            <Card className="w-full mx-auto max-w-xs rounded-2xl border-b-4 hover:border-[#ffffff] border-[#f7ac0a3a] backdrop-blur-[1px]">
                <p className='flex gap-2.5 items-center text-tremor-default text-dark-tremor-content-strong'>
                    Visitor's today <Badge percentage={(amtVisitorsToday / Number(avgVisitorsPerDay) - 1) * 100} />
                </p>
                <p className='text-3xl text-dark-tremor-content-strong font-semibold'>
                   {amtVisitorsToday}
                </p>
        ...
        <Card className='flex flex-col sm:grid grid-cols-4 gap-6 backdrop-blur-[1px]'>
        ...
        <Card className='backdrop-blur-[1px] rounded-2xl border-b-4 hover:border-[#ffffff]'>
            {timeseriesPageviews ? (
                <AreaChart  
                      allowDecimals={false}
                      showAnimation
